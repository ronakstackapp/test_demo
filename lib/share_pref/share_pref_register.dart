...
class SharePrefRegisterScreen extends StatefulWidget {
  const SharePrefRegisterScreen({Key? key, this.userModel}) : super(key: key);
  final UserModel? userModel;


  @override
  _SharePrefRegisterScreenState createState() => _SharePrefRegisterScreenState();
}
class _SharePrefRegisterScreenState extends State<SharePrefRegisterScreen> {
